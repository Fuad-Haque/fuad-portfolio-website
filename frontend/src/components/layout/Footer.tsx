...
export function Footer() {
  return (
    <footer className="relative border-t border-[#1A1A2E] mt-32 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-start pointer-events-none select-none" aria-hidden="true">
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="border-t border-[#1A1A2E] mt-10 pt-6 flex items-center justify-between">
          <span className="font-mono text-[0.7rem] text-[#303055]">fuadhaque.com © 2026</span>
          <div className="flex items-center gap-4">
            <span className="font-mono text-[0.7rem] text-[#303055]">Built with FastAPI + Next.js</span>
            <a href="https://api.fuadhaque.com/health" target="_blank" rel="noopener noreferrer" className="font-mono text-[0.7rem] text-[#303055] hover:text-[#00D4AA] transition-colors duration-150">api/health</a>
          </div>
        </div>
      </div>
    </footer>
